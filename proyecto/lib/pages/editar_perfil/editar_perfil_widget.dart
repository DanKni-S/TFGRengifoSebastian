  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsuarioRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsuarioRecord> editarPerfilUsuarioRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final editarPerfilUsuarioRecord =
            editarPerfilUsuarioRecordList.isNotEmpty
                ? editarPerfilUsuarioRecordList.first
                : null;
            ...
            body: SingleChildScrollView(
              child: Column(
                ...
                children: [
                                ...
                                Container(
                                  ...
                                  child: Image.network(
                                    valueOrDefault<String>(
                                      _model.uploadedFileUrl_uploadDataUjs,
                                      'https://cdn-icons-png.flaticon.com/512/685/685668.png',
                                    ),
                                    fit: BoxFit.cover,
                                  ),
                                ),
                                      ...
                                      onTap: () async {
                                        ...
                                        if (selectedMedia != null &&
                                          ...
                                          try {
                                            ...
                                            _model.isDataUploading_uploadDataUjs =
                                                false;
                                          }
                                          if (selectedUploadedFiles.length ==
                                              ...
                                              downloadUrls.length ==
                                                  selectedMedia.length) {
                                            safeSetState(() {
                                              _model.uploadedLocalFile_uploadDataUjs =
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        controller: _model.nombreNuevoTextController ??=
                          ...
                          text: editarPerfilUsuarioRecord?.displayName,
                        ),
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      await editarPerfilUsuarioRecord!.reference
                          .update(createUsuarioRecordData(
                        displayName: _model.nombreNuevoTextController.text,
                        photoUrl: _model.uploadedFileUrl_uploadDataUjs,
                      ));
